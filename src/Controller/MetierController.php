...
class MetierController extends AbstractController
{
    ...
    /**
     * @Route("/api/{ecosystem}", name="metiers_api", methods={"GET"})
     */
    public function metiersApi(MetierRepository $metierRepository,Request $request)
    {
        $data = array();
        $ecos=$request->get('ecosystem');
